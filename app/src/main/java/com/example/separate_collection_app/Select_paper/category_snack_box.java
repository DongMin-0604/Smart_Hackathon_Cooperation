...
public class category_snack_box extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_snack_box newInstance(){
        return new category_snack_box();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_snack_box, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),85,88,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

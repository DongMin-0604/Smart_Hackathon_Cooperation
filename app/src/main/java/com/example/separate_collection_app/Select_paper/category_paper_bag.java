...
public class category_paper_bag extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_paper_bag newInstance(){
        return new category_paper_bag();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_paper_bag, null);

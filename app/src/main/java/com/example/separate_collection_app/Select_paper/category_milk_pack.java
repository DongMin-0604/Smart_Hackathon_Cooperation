...
public class category_milk_pack extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_milk_pack newInstance(){
        return new category_milk_pack();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_milk_pack, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),30,34,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),67,72,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

...
public class category_receipt extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_receipt newInstance(){
        return new category_receipt();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_receipt, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),33,38,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

...
public class category_flyer extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_flyer newInstance(){
        return new category_flyer();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_flyer, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),27,33,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

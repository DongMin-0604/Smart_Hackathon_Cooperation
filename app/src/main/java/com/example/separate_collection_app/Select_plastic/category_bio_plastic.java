...
public class category_bio_plastic extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_bio_plastic newInstance(){
        return new category_bio_plastic();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_bio_plastic, null);

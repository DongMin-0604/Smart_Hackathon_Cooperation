...
public class category_cassette_tape extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_cassette_tape newInstance(){
        return new category_cassette_tape();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_cassette_tape, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),17,23,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),47,51,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),56,62,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

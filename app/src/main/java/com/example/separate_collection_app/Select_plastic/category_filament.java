...
public class category_filament extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_filament newInstance(){
        return new category_filament();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_filament, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),9,17,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),43,48,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

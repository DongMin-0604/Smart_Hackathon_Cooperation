...
public class category_disposable_container extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_disposable_container newInstance(){
        return new category_disposable_container();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_disposable_container, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),26,31,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,57,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

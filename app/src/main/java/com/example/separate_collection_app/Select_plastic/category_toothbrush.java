...
public class category_toothbrush extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_toothbrush newInstance(){
        return new category_toothbrush();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_toothbrush, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),24,39,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

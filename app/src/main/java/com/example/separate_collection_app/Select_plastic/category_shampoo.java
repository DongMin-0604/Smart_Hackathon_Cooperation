...
public class category_shampoo extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_shampoo newInstance(){
        return new category_shampoo();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_shampoo, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),41,67,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),117,122,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

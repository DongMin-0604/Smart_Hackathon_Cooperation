...
public class category_strainer extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_strainer newInstance(){
        return new category_strainer();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_strainer, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),31,35,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

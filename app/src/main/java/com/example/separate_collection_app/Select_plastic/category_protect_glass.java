...
public class category_protect_glass extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_protect_glass newInstance(){
        return new category_protect_glass();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_protect_glass, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),5,9,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

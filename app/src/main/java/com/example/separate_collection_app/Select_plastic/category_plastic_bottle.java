...
public class category_plastic_bottle extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_plastic_bottle newInstance(){
        return new category_plastic_bottle();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_plastic_bottle, null);

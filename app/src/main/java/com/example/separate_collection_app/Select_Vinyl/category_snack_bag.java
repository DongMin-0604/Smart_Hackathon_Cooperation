...
public class category_snack_bag extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_snack_bag newInstance(){
        return new category_snack_bag();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_snack_bag, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),28,32,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,48,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

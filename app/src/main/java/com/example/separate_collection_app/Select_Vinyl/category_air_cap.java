...
public class category_air_cap extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_air_cap newInstance(){
        return new category_air_cap();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_air_cap, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),20,23,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

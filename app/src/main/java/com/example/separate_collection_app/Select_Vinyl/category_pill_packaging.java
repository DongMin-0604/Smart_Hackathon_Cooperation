...
public class category_pill_packaging extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_pill_packaging newInstance(){
        return new category_pill_packaging();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_pill_packging, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),17,20,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),80,86,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

...
public class category_plastic_bag extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_plastic_bag newInstance(){
        return new category_plastic_bag();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_plastic_bag, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),6,9,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

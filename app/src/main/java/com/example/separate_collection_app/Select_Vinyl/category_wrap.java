...
public class category_wrap extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_wrap newInstance(){
        return new category_wrap();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_wrap, null);

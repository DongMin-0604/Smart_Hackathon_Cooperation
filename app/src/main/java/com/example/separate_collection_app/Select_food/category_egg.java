...
public class category_egg extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),30,35,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,32,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

...
public class category_bone extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_bone newInstance(){
        return new category_bone();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_bone, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),0,12,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),41,47,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

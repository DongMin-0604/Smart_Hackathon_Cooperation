...
public class category_tangerine extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_tangerine newInstance(){
        return new category_tangerine();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_tangerine, null);
        ...
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,60,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

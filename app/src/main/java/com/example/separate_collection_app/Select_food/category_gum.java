...
public class category_gum extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_gum newInstance(){
        return new category_gum();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_gum, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),3,10,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),49,54,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

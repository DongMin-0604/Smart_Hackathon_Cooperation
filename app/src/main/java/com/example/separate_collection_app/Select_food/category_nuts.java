...
public class category_nuts extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_nuts newInstance(){
        return new category_nuts();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_nuts, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),39,45,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

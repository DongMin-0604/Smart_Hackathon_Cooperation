...
public class category_shellfish extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_shellfish newInstance(){
        return new category_shellfish();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_shellfish, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),0,7,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),44,49,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,24,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

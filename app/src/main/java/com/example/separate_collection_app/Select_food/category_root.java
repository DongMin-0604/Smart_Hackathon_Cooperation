...
public class category_root extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_root newInstance(){
        return new category_root();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_root, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),39,43,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

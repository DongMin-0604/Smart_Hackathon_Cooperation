...
public class category_crab extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_crab newInstance(){
        return new category_crab();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_crap, null);

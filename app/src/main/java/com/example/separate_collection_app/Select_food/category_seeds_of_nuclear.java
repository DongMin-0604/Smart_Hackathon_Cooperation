...
public class category_seeds_of_nuclear extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_seeds_of_nuclear newInstance(){
        return new category_seeds_of_nuclear();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_seeds_of_nuclear, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),0,17,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),52,57,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,39,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

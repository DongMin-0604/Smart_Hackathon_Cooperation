...
public class category_fruit extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_fruit newInstance(){
        return new category_fruit();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_fruit, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),0,13,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

...
public class category_coffee_pot extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_coffee_pot newInstance(){
        return new category_coffee_pot();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_coffee_pot, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),33,50,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

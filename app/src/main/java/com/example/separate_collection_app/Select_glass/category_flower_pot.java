...
public class category_flower_pot extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_flower_pot newInstance(){
        return new category_flower_pot();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_flower_pot, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),32,42,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

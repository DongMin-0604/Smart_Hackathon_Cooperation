...
public class category_lid extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_lid newInstance(){
        return new category_lid();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_lid, null);

...
public class category_lamp extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_lamp newInstance(){
        return new category_lamp();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_lamp, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),32,46,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),57,78,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);


        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,51,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

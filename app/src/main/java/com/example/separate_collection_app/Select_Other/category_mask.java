...
public class category_mask extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_mask newInstance(){
        return new category_mask();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_mask, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),8,13,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

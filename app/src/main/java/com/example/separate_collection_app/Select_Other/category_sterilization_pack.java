...
public class category_sterilization_pack extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_sterilization_pack newInstance(){
        return new category_sterilization_pack();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_sterilization_pack, null);

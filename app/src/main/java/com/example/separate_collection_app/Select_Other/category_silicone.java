...
public class category_silicone extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_silicone newInstance(){
        return new category_silicone();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_silicone, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),21,26,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

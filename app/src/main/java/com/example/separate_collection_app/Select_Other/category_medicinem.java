...
public class category_medicinem extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_medicinem newInstance(){
        return new category_medicinem();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_medicinem, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),30,38,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        Spannable spannable1 = (Spannable)textView2.getText();
        spannable1.setSpan(new ForegroundColorSpan(Color.rgb(159,33,33)),0,47,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

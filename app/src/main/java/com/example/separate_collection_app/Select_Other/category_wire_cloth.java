...
public class category_wire_cloth extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),14,18,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),25,30,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

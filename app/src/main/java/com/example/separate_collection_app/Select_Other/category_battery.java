...
public class category_battery extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_battery newInstance(){
        return new category_battery();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_battery, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),34,45,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

...
public class category_wet_tissue extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_wet_tissue newInstance(){
        return new category_wet_tissue();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_wet_tissue, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),28,33,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

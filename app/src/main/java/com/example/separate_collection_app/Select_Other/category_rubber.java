...
public class category_rubber extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_rubber newInstance(){
        return new category_rubber();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_rubber, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),29,35,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

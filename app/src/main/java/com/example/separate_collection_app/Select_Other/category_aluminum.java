...
public class category_aluminum extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_aluminum newInstance(){
        return new category_aluminum();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_aluminum, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),43,46,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

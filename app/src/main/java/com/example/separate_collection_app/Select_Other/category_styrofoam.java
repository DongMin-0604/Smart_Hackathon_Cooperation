...
public class category_styrofoam extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_styrofoam newInstance(){
        return new category_styrofoam();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_styrofoam, null);
        ...
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),36,48,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannable.setSpan(new ForegroundColorSpan(Color.rgb(79,60,151)),91,96,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

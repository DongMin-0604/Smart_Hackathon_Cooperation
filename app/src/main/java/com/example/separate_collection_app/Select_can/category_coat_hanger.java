...
public class category_coat_hanger extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_coat_hanger newInstance(){
        return new category_coat_hanger();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_coat_hanger, null);

...
public class category_cans extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_cans newInstance(){
        return new category_cans();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_cans, null);

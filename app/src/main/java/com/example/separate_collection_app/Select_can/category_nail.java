...
public class category_nail extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_nail newInstance(){
        return new category_nail();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_nail, null);

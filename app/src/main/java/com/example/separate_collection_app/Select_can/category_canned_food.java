...
public class category_canned_food extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_canned_food newInstance(){
        return new category_canned_food();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_canned_food, null);

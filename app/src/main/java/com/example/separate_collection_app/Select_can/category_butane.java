...
public class category_butane extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_butane newInstance(){
        return new category_butane();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_butane, null);

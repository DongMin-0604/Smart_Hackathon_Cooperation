...
public class category_umbrella extends Fragment {

    Button back_BT;
    TextView textView, textView2;

    public static category_umbrella newInstance(){
        return new category_umbrella();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_category_select_umbrella, null);
